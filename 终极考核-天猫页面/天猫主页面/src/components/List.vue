<template>
  <div class="goods_list">
    ...
    <div class="content">
      <div class="left_info" style="font-size:12px;" :style="{backgroundColor:background}">
        ...
        <a href="javascript:" v-for="(obj,id) in arr" :key="id">
          <div>
            ...
            <span class="price">
              <i>¥</i>
              <p>{{ obj.price }}</p></span>
            <button @click="obj.count>0&&obj.state==true?addgood(obj):none()"><img
                src="../assets/购物车.png" alt=""
                v-if="obj.count>0">
              <img src="../assets/购物车无.png" alt="" v-else>
            </button>
  ...
  .content {
    ...
    .goods {
      ...
      .product-mask {
        ...
        width: 95px;
        height: 95px;
        background: url(../assets/soldout.png) no-repeat;
        left: 50px;
        top: -170px;
      }
