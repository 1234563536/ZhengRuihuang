<template>
  <div style="width: 100%; height: 923px; margin: 0 auto; overflow: hidden">
    <div class="header">
      <a href="javascript:"><img src="../../loginpic/tmall.png" alt=""/></a>
    </div>
    <div class="main">
      <a href="javascript:"><img src="../../loginpic/tmall_main.png" alt=""/></a>
      <div class="login-box">
        ...
        >
          ...
          ><img src="../../loginpic/二维码.png" alt=""/></a
          ></span>

        <div class="passenter" v-if="isShow" style="float:left;position:relative;top:-90px">
          <form class="layui-form" id="form_login" method="post">
            <div class="layui-form-item" style="float: left;height: 40px;">
              <label class="layui-form-label" style="height:40px;width:40px;background-color:#CCCCCC;float:left;top:0;"><img
                  src="../../loginpic/用户.png" alt="" style="float:left;left:8px;top:5px;position:absolute"></label>
              <div class="layui-input-block" style="width:250px;height:42px;float:left;left:-19.5%;top:-40px;">
                <input
                    v-model="username"
                    type="text"
                    name="username"
                    ...
                    autocomplete="off"
                    class="layui-input"
                    style="border-left:0;height:40px;font-size:16px;"
                />
              </div>
            </div>
            <div class="layui-form-item" style="margin-top:-40px;">
              <label class="layui-form-label" style="height:40px;width:40px;background-color:#CCCCCC;float:left;top:0;"><img
                  src="../../loginpic/密码.png" alt="" style="float:left;left:8px;top:5px;position:absolute"></label>
              <div class="layui-input-inline" style="width:250px;height:42px">
                <input
                    v-model="password"
                    type="password"
                    name="password"
            ...
            <div class="layui-form-item">
              ...
              <button class="layui-btn layui-btn-fluid layui-btn-normal"
                      lay-submit
                      @click="loginbtn"
                      style="width:300px;height:42px;background-color:#FF0036">登录
              </button>
            </div>
            <span style="padding-left:114px"><a href="javascript:">更新密码</a></span>
            <span><a href="javascript:">忘记用户名</a></span>
            <span><a href="/register">免费注册</a></span>
          </form>
        </div>
        <div class="messageenter" v-else style="float:left;position:relative;top:-70px">
          <form class="layui-form" action="">
            <div class="layui-form-item" style="float: left;height: 40px;">
              <label class="layui-form-label" style="height:40px;width:40px;background-color:#CCCCCC;float:left;top:0;"><img
                  src="../../loginpic/手机.png" alt="" style="float:left;left:8px;top:5px;position:absolute"></label>
              <div class="layui-input-block" style="width:250px;height:42px;float:left;left:-19.5%;top:-40px;">
                <input
                    type="text"
                    name="mobile"
            ...
            <div class="layui-form-item" style="margin-top:-40px;">
              <label class="layui-form-label" style="height:40px;width:40px;background-color:#CCCCCC;float:left;top:0;"><img
                  src="../../loginpic/验证码.png" alt="" style="float:left;left:8px;top:5px;position:absolute"></label>
              <div class="layui-input-inline" style="width:250px;height:42px">
                <input
                    type="text"
                    name="code"
                ...
                <button
                    ...
                    style="float:left;left:170px;top:-30px;position: relative;background-color: #fff;border: none;cursor:pointer"
                    v-if="!isSend">
                  发送验证码
                </button>
                <div v-else
                     style="width:30px;height: 30px;float: right;position: relative;top:-35px;left:-10px;"
                     class="revcount">
                  <span style="line-height: 10px;text-align: center;color:#6c6c6c">{{ this.revnumber }}s</span>
                </div>
              </div>
            </div>
            <div class="layui-form-item">
    ...
    <div class="bottom">
      ...
      <div class="tel">
        ...
        >
        <span>
          <img src="../../loginpic/police.png" alt=""/>
...
window.layui.use(['jquery', 'layer'], function () {
  ...
  $('#form_login').on('submit', function (e) {
    e.preventDefault()
    // window.__VUE_HOT_MAP__.aeba673c.options.methods.loginbtn();
    return false
  });
  form.verify({
...
export default {
  ...
  methods: {
    ...
    loginbtn() {
      if (this.username.trim() != '' && this.password.length > 5 && this.password.length < 13) {
        let self = this
        this.$axios({
          url: "/api/login",
          method: "post",
