  ...
  <div style="width: 100%; height: 923px; margin: 0 auto; overflow: hidden">
    ...
    <div class="main">
      ...
      <div class="login-box">
        ...
        <div class="passenter reg-box" style="float:left;position:relative;top:-90px">
          <form class="layui-form" id="form_register" method="post">
            ...
            <div class="layui-form-item">
              ...
              <button class="layui-btn layui-btn-fluid layui-btn-normal" lay-submit
                      @click="registerbtn"
                      style="width:300px;height:42px;background-color:#FF0036">注册
              </button>
            </div>
            <span style="margin-left:264px"><a href="/login">登录</a></span>
          </form>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    registerbtn() {
      if (this.username.trim() != '' && this.password.length > 5 && this.password.length < 13 && this.password === this.repassword) {
        var self = this
        this.$axios({
          url: "/api/reguser",
          method: "post",
          ...
          transformRequest: [function (data) {
            ...
            return ret
              ...
              if (res.data.status === 0) {
                setTimeout(function () {
                  window.layer.msg("恭喜你，注册成功!")
                  location.href = 'http://192.168.1.100:8080/login'
                }, 2000)
              } else {
                setImmediate(function () {
                  window.layer.msg("您的用户名已经被占用!请重新输入")
                }, 2000)
              }
            }
        )
